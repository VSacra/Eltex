...
int main(int argc, char **argv) {
    ...
    if (argc != 2) {
        printf("Неверно указаны аргументы. Формат: %s <IP_адрес_клиента2>\n", argv[0]);
    ...
    cliaddr.sin_port = htons(51001);        // Порт клиента 2 (51001)
    ...
    myaddr.sin_port = htons(51000);         // Мой порт (51000)
    ...
    printf("Клиент 1 запущен\n");
    printf("Мой порт: 51000\n");
    printf("Собеседник: %s:51001\n", argv[1]);
